...
1. **Set Up Encryption in Twilio:**
    ...
    - Click on "Add Function" and paste the following code: 
        - **[Encrypt Function](https://github.com/PovertyAction/requests_to_twilio/blob/master/twilio_encrypt_fields.js)**
...
2. **Run Decryption Code:**
    ...
    python .\csv_decryptor.py \\\
        --encrypted_csv_path X:\path\to\your\csv\demo.csv \\\
        --list_of_columns_to_decrypt col1,col2  \\\
