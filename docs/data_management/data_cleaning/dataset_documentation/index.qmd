...
Many statistical software have built in resources to produce documented datasets. This section discusses standards for documentation, specifically focusing on Stata’s commands to name, label, and add notes to variables. Resources on other statistical software, such as [tibbles in R](https://r4ds.had.co.nz/tibbles.html) are not discussed in this section, but general lessons for code structure can be applied. This section also does not discuss standards for interpretable coding.
